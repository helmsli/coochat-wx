...
public class OrderClientService {
	...
	public ProcessResult saveUserOrder(String userDbWriteUrl, UserOrder userOrder) {
		...
		String url = userWebUrl + "/" + userOrder.getCategory() + "/" + userOrder.getUserId() + "/configUserOrder";
		logger.debug("saveUserOrder url=" + url + ",userOrder=" + userOrder);
	...
	public ProcessResult delUserOrder(String userDbWriteUrl, UserOrder userOrder) {
		...
		result = restTemplate.postForObject(
				userWebUrl + "/" + userOrder.getCategory() + "/" + userOrder.getUserId() + "/delUserOrder", userOrder,
				ProcessResult.class);
		return result;
	}
	...
	public ProcessResult queryAllUserOrderIdAsc(String userDbWriteUrl, String category, String userId, Date startTime,
		...
		result = restTemplate.postForObject(userWebUrl + "/" + category + "/" + userId + "/queryUserOrderidAsc",
	...
	public ProcessResult updateUserOrderStatus(String userDbWriteUrl, UserOrder userOrder) {
		...
		ProcessResult result = null;
		result = restTemplate.postForObject(
				userDbWriteUrl + "/" + userOrder.getCategory() + "/" + userOrder.getUserId() + "/updateUserOrderStatus",
	...
	public ProcessResult queryOneOrder(String userDbReadUrl, UserOrder userOrder) {
		...
		String postUrl = userWebUrl + "/" + userOrder.getCategory() + "/" + userOrder.getUserId() + "/queryOneOrder";
		logger.debug("queryOneOrder postUrl=" + postUrl + ",parm=" + userOrder);
		result = restTemplate.postForObject(postUrl, userOrder, ProcessResult.class);
	...
	public ProcessResult queryUserOrderByPage(String userDbReadUrl, String routeId,
			QueryUserOrderRequest queryUserOrderRequest) {
		...
		result = restTemplate.postForObject(
				userWebUrl + "/" + queryUserOrderRequest.getCategory() + "/" + routeId + "/queryUserOrder",
				queryUserOrderRequest, ProcessResult.class);
		if (result.getRetCode() == 0) {
